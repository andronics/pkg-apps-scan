...
All notable changes to @apps/scan will be documented in this file.
...
- Declared external command requirements: scanimage
...
- Package naming now includes collection scope: `@apps/scan`
